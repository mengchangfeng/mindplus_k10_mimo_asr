// Header-only implementation for the Mind+ K10 extension.
#ifndef K10_MIMO_AUDIO_INL
#define K10_MIMO_AUDIO_INL
...
namespace k10_mimo_audio_detail {

static String _k10MimoAsrApiKey = "";
static String _k10MimoAsrModel = "mimo-v2.5-asr";
static String _k10MimoAsrApiUrl = "https://api.xiaomimimo.com/v1";
static String _k10MimoTtsModel = "mimo-v2.5-tts";
static String _k10MimoTtsVoice = "冰糖";
static const uint32_t _k10MimoAsrSampleRate = 16000;
static const uint16_t _k10MimoAsrBitsPerSample = 16;
static const uint16_t _k10MimoAsrChannels = 1;
static uint8_t _k10MimoAsrMaxSeconds = 5;
static uint8_t *_k10MimoAsrPcmBuffer = NULL;
static uint32_t _k10MimoAsrPcmBytes = 0;
static uint32_t _k10MimoAsrLastElapsedMs = 0;
static volatile bool _k10MimoAsrRecording = false;
static volatile bool _k10MimoAsrTaskRunning = false;
static TaskHandle_t _k10MimoAsrTaskHandle = NULL;
static bool _k10MimoAsrInited = false;

static void _k10MimoAsrWriteWavHeader(uint8_t *wav, uint32_t pcmDataSize) {
...
static String _k10MimoAsrBase64Encode(uint8_t *data, size_t dataLen) {
...
static String _k10MimoAsrParseText(String response) {
...
static bool _k10MimoAsrWriteAll(ClientType &client, const char *data, size_t len) {
  size_t sent = 0;
...
template <typename ClientType>
static bool _k10MimoAsrWriteAll(ClientType &client, const String &data) {
  return _k10MimoAsrWriteAll(client, data.c_str(), data.length());
}

static String _k10MimoAsrReadHttpBody(WiFiClientSecure &client, bool chunked, int contentLength) {
  String body;
  body.reserve(2048);
...
static String _k10MimoTtsJsonEscape(const String &text) {
  String out;
...
static bool _k10MimoTtsPlayWav(uint8_t *wav, size_t wavLen) {
...
static String _k10MimoTtsSpeak(const String &text, const String &style) {
...
static void _k10MimoAsrEs7243Write(uint8_t reg, uint8_t val) {
...
static bool _k10MimoAsrInitES7243E() {
  Wire.beginTransmission(0x11);
  Wire.write(0xFD);
...
static void _k10MimoAsrRecordTask(void *param) {
...
static String _k10MimoAsrSendWav(uint8_t *wavBuffer, uint32_t wavBytes) {
...
static void _k10MimoAsrBegin(String apiKey, String voice) {
  Wire.begin(48, 47);
...
static bool _k10MimoAsrStartRecording() {
...
static String _k10MimoAsrStopAndRecognize() {
  if (!_k10MimoAsrInited) return "未初始化";
...
inline void k10MimoInit(const String &apiKey, const String &voice) {
  k10_mimo_audio_detail::_k10MimoAsrBegin(apiKey, voice);
}

inline bool k10MimoStartRecording() {
  return k10_mimo_audio_detail::_k10MimoAsrStartRecording();
}

inline String k10MimoStopAndRecognize() {
  return k10_mimo_audio_detail::_k10MimoAsrStopAndRecognize();
}

inline String k10MimoSpeak(const String &text, const String &style) {
  return k10_mimo_audio_detail::_k10MimoTtsSpeak(text, style);
}
